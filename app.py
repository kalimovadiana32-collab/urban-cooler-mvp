...
with st.expander("📖 ИНСТРУКЦИЯ И ИСТОЧНИКИ СНИМКОВ"):
    col_text, col_links = st.columns([2, 1])
    
    with col_text:
        st.markdown("""
        ### Как подготовить снимок:
        1. Перейдите на одну из карт (ссылки справа).
        2. Найдите нужный участок города.
        3. Масштаб: **300-500 метров** (квартал должен занимать большую часть экрана).
        4. Сделайте скриншот строго **вид сверху** (клавиша 'U' в Google Maps выравнивает надир).
        5. Загрузите файл в систему.
        """)
        
    with col_links:
        st.markdown("### 🔗 Где взять снимки:")
        ...
        st.markdown("- [Esri Wayback](https://livingatlas.arcgis.com/wayback/) (Архивные снимки)")
